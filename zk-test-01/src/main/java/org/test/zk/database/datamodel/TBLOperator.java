...
public class TBLOperator extends CAuditableDataModel implements Serializable {
    ...
    //Constructor
    public TBLOperator( String strId, String strName, String strPassword, String strComment, String strDisabledBy, LocalDate disabledAtDate, LocalTime disabledAtTime, LocalDate lastLoginAtDate, LocalTime lastLoginAtTime ) {
        ...
        this.lastLoginAtDate = disabledAtDate;
        this.lastLoginAtTime = disabledAtTime;
